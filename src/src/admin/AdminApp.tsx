...
import { Users, BarChart3, FileText, ShieldAlert, Settings, LogOut, CheckCircle, XCircle, Search, Wallet } from 'lucide-react';
                    ...
                    {activeTab === 'DASHBOARD' && (
                        <div className="space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                                ...
                                <StatCard title="Active Projects" value="843" icon={FileText} color="text-emerald-600" />
                            ...
                            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                                ...
                                <div className="space-y-4">
                                    <div className="p-4 bg-red-50 border border-red-100 rounded-lg flex gap-4">
                                        <div className="w-20 h-20 bg-slate-300 rounded overflow-hidden shrink-0"><img src="https://picsum.photos/seed/bad/100/100" className="w-full h-full object-cover grayscale"/></div>
                                        <div className="flex-1">
                                            <h4 className="font-bold text-red-900 text-sm">Project: Dark Knight Rises</h4>
                                            <p className="text-xs text-red-700 mb-2">Reason: Excessive Violence (Confidence: 98%)</p>
                                            <div className="flex gap-2">
                                                <button className="px-3 py-1 bg-white border border-red-200 text-red-600 rounded text-xs font-bold hover:bg-red-600 hover:text-white transition-colors">Takedown</button>
                                                <button className="px-3 py-1 bg-white border border-slate-200 text-slate-600 rounded text-xs font-bold hover:bg-slate-100">Ignore</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
